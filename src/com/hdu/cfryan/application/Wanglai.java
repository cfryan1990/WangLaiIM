package com.hdu.cfryan.application;
...
public class Wanglai extends Application {
	public static final int NUM_PAGE = 6;// ×Ü¹²ÓÐ¶àÉÙÒ³
	public static int NUM = 20;// Ã¿Ò³20¸ö±íÇé,»¹ÓÐ×îºóÒ»¸öÉ¾³ýbutton
	private Map<String, Integer> mFaceMap = new LinkedHashMap<String, Integer>();
	private static Wanglai mApplication;

	public synchronized static Wanglai getInstance() {
		return mApplication;
	}
