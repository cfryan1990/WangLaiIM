...
//		}
	...
	public Cursor query(Uri url, String[] projectionIn, String selection,
		...
		if (TextUtils.isEmpty(sortOrder) && match == CONTACTS) {
			orderBy = PhoneConstants.DEFAULT_SORT_ORDER;//Ä¬ÈÏ°´ÔÚÏß×´Ì¬ÅÅÐò
		} else {
			orderBy = sortOrder;
		}
...
//	}
	...
	public static final class PhoneConstants implements BaseColumns {
		...
		public static final String NAME = "name";//´æ´¢ÐÕÃû
		public static final String PHONE_NUM = "phone_num";//ºÅÂë´æ´¢
		public static final String STATUS = "status";//Ìí¼ÓºÃÓÑµÄ×´Ì¬
