...
//		}
	...
	public Cursor query(Uri url, String[] projectionIn, String selection,
		...
		if (TextUtils.isEmpty(sortOrder) && match == CONTACTS) {
			orderBy = NewFriendsConstants.DEFAULT_SORT_ORDER;//Ä¬ÈÏ°´ÔÚÏß×´Ì¬ÅÅÐò
		} else {
			orderBy = sortOrder;
		}
...
//	}
	...
	public static final class NewFriendsConstants implements BaseColumns {
		...
		public static final String NAME = "name";//´æ´¢Ãû×Ö
		public static final String JID = "jid";//ºÅÂë´æ´¢
		public static final String STATUS = "status";//ºÃÓÑÌí¼ÓÈ·ÈÏ×´Ì¬
