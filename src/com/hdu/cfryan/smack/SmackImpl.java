...
public class SmackImpl implements Smack
{
	...
	private static final String PING_ALARM = "com.zjstone.PING_ALARM";// ping服务器闹钟BroadcastReceiver的Action
	private static final String PONG_TIMEOUT_ALARM = "com.zjstone.PONG_TIMEOUT_ALARM";// 判断连接超时的闹钟BroadcastReceiver的Action
	...
	/******************************* start联系人头像Vcard处理 ，包含Vcard本地化和Vcard更新**********************************/
	/**
	 * 获取头像保存到本地
	 * 
	 */
...
//			t.start();
	...
	/************************ end联系人头像Vcard处理 ，包含Vcard本地化和Vcard更新 ********************************/
	
	
	/********************** start 添加好友,手机通讯录联系人存入本地数据库，登录时检查联系人是否更新***********************/
	/**
	 * 获取手机联系人
	 */
	@SuppressLint("NewApi")
...
//				}
	...
	/********************** end 添加好友,手机通讯录联系人存入本地数据库，登录时检查联系人是否更新***********************/
