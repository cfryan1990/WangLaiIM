...
public class PreferenceConstants {
	public static final String DEFAULT_SERVER = "192.168.1.103";
	public static final String DEFAULT_SERVER_NAME = "ryan-pc";
	public static final String REMOTE_HOST = "http://192.168.1.103:8080";//上传下载服务器地址
